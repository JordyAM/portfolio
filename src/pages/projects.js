    ...
    return (
        ...
        className="text-gray-900 absolute top-0 left-0 w-full h-full bg-red-400 lg:px-48 px-16">
            <div className="mt-48 p-1 overflow-hidden">
                ...
                className="text-6xl text-center lg:text-right lg:text-6xl">My Projects</m.h1>
            </div>
            <div>
           ...
           <div className="site-container"><h1>A Final Fantasy XIV Character Viewer</h1>
            ...
            <a className="project-url" href="https://ffxiv-viewer.netlify.app/"><h3>App</h3></a>
            </div>
           <div className="site-container">
            ...
            <a className="project-url" href="https://animated-pony-a34044.netlify.app/"><h3>App</h3></a>
            </div>
        </div>
        </m.main>
    )
